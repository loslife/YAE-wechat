var logger = require("./utils/logger").getLogger(),
    ...
    session_refresh = require("./express-middleware/session-refresh"),
    preload_member = require("./express-middleware/preload-member");
...
void main(function () {
    ...
    function initExpress() {
        ...
        app.use(express.bodyParser())
            ...
            .use("/svc/wsite", session_refresh)
            .use("/svc/wsite", preload_member)
            .use("/svc/weixinInterface", wx.xml_parser())
            .use(statistics);
        ...
        if (handle) {
            ...
            app.use(function (err, req, res, next) {
                ...
                if (errHander) {
                    ...
                    if (utils.isXhr(req)) {
                        res.send(wrapError(err, errHander));
                    } else {
                        res.render("error", {layout: "error_layout", error: err});
                    }
