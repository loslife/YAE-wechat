...
void main(function () {
    ...
    function initExpress() {
        ...
        app.use(express.bodyParser({
            ...
            .use("/svc/partner", express.cookieParser())
            .use("/svc/partneradmin", express.cookieParser())
            .use("/svc/sysadmin", express.cookieParser())
            .use("/svc/formlogin", express.cookieParser())
            .use("/svc/store", express.cookieParser())
            .use("/svc/wsite", express.cookieParser())
            ...
            .use("/svc/partner", express.session({
                store: new MongoStore({
                    url: 'mongodb://' + global['_g_topo'].dataServer.mongodb.connectionurl + '/yilos_session'
                }),
                cookie: {
                ...
                secret: '1234567890QWERTYqwerty'
            }))
            .use("/svc/partneradmin", express.session({
                store: new MongoStore({
                    url: 'mongodb://' + global['_g_topo'].dataServer.mongodb.connectionurl + '/yilos_session'
                }),
                cookie: {
                ...
                secret: '1234567890QWERTYASDFGH'
            }))
            .use("/svc/sysadmin", express.session({
                store: new MongoStore({
                    url: 'mongodb://' + global['_g_topo'].dataServer.mongodb.connectionurl + '/yilos_session'
                }),
                cookie: {
            ...
            .use("/svc/formlogin", express.session({
                store: new MongoStore({
                    url: 'mongodb://' + global['_g_topo'].dataServer.mongodb.connectionurl + '/yilos_session'
                }),
                cookie: {
            ...
            .use("/svc/weixin-api", wx.xml_parser())
